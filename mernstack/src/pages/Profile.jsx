    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <p className="text-small self-center">
          {fileUploadError ? (
            <span className="text-red-700">
              Error Iploading image (image must be less than 2mb)
            </span>
        ...
        <button
          disabled={loading}
          type="submit"
          className="bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 mt-4"
        >
          {loading ? "loading" : "update"}
        </button>
        <Link
          className="bg-green-700 text-white p-3 rounded-lg text-center uppercase hover:opacity-95 my-5"
          to={"/create-listing"}
        >
          Create Listing
        </Link>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <button className="green-red-700 uppercase ">Edit</button>
                </div>
              </div>
            )
          })}
